...
export const headerIntroData = {
  ...
  description: {
    ...
    en: "I'm EphreM kapo, a senior graphic designer with a decade of experience, and I'm as passionate about the work now as when I first started. I leap at the opportunity to solve difficult creative problems that result in helping brands grow and evolve. I want to thank you for taking the time to read this, and I hope we get the chance to speak more about the opportunity.",
  },
  buttons: [
    {
      name: "Contact",
...
export const quotesData = [
  {
    ...
    en: `"Design is the silent ambassador of your brand, speaking volumes through creativity and visual storytelling."`,
    author: "Andrew Hunt",
  },
  {
    de: '"Das Web ist wie eine Leinwand und der Code ist die Farbe. Erschaffe dein Meisterwerk."',
    en: `"Graphic design is like a canvas, and creativity is the paint."`,
  },
] as const;
...
export const aboutMeData = {
  ...
  paragraphs_EN: [
    {
      title: "Eduaction",
      description: "2018 - 2022 BS Degree in Computer Science, Dire Dawa University. 2023 Foundations of User Experience (UX) Design, Google",
      icon: hardwareicon,
    },
    {
      title: "Experience",
      description:
        " 1) Graphic Designe, Royal Realestate(K.A.M), JULY 5, 2023 - present. 2) TAZA PROPERTIES, May 11,2023 present",
      icon: caricon,
    },
    {
      title: "Skill Set",
      description:
        "Photoshop, InDesign, Illustrator, After Effects, Premiere Pro, and Figma. Proficient in full-stack web development.",
      icon: travelicon,
    },
  ],
};
